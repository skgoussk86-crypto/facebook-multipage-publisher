      ...
      <div className="flex flex-1 flex-col lg:flex-row">
        ...
        <aside className="flex w-full shrink-0 flex-col gap-5 border-b border-zinc-200 bg-white p-4 sm:p-6 lg:w-64 lg:border-b-0 lg:border-r lg:border-zinc-200">
          ...
          <nav className="grid grid-cols-2 gap-2 sm:grid-cols-4 lg:flex lg:flex-col">
            ...
            <Link
              ...
              className="rounded-lg border border-indigo-700 bg-indigo-600 px-3 py-2.5 text-center text-xs font-semibold text-white shadow-sm lg:text-left lg:text-sm"
            >
        ...
        <main className="min-w-0 flex-1 space-y-7 overflow-y-auto bg-zinc-50 p-4 sm:p-6 lg:p-10">
          <header>
            ...
            <h2 className="mt-1 text-2xl font-bold text-zinc-900">Google Drive Storage</h2>
          ...
          <section className="max-w-4xl space-y-3" aria-live="polite">
            {(successMessage || disconnectSuccess) && (
              <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-xs font-medium leading-relaxed text-emerald-800">
          ...
          {isLoading ? (
            <div className="py-12 max-w-4xl rounded-xl border border-zinc-200 bg-white text-center font-mono text-xs text-zinc-500">
              Loading Google Drive configuration status...
            </div>
          ) : (
            <div className="max-w-4xl grid grid-cols-1 gap-6">
              <section className="min-w-0 space-y-6 rounded-xl border border-zinc-200 bg-white p-4 shadow-sm sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-zinc-200 pb-4 gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {status && status.connected ? (
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium border border-emerald-200 bg-emerald-50 text-emerald-800">
                        Connected
                      </span>
                    ) : (
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium border border-rose-200 bg-rose-50 text-rose-800">
                        Disconnected
                      </span>
                    )}
                  </div>
                ...
                {status && (
                  <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div className="space-y-1">
                      ...
                      <span className="block text-sm text-zinc-900 break-all">
                    ...
                    {status.revokedAt && (
                      <div className="space-y-1">
                        ...
                        <span className="block text-sm text-rose-800">
                    ...
                    <div className="space-y-2 md:col-span-2">
                      ...
                      <span className="block rounded-lg border border-zinc-200 bg-zinc-100 p-2.5 font-mono text-xs text-zinc-600 break-all select-all">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3 border-t border-zinc-200 pt-6">
                  <div className="flex flex-wrap items-center gap-3">
                    {status && !status.connected ? (
                      ...
                      <>
                        <Link
                          ...
                          className={`inline-flex items-center justify-center rounded-lg border border-zinc-200 bg-zinc-100 px-4 py-2.5 text-xs font-semibold text-zinc-700 transition hover:bg-zinc-200 ${
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center rounded-lg border border-zinc-200 bg-zinc-100 px-4 py-2.5 text-xs font-semibold text-zinc-700 transition hover:bg-zinc-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <Link
                      ...
                      className={`inline-flex items-center justify-center rounded-lg border border-zinc-200 bg-zinc-50 px-4 py-2.5 text-xs font-semibold text-zinc-600 hover:text-zinc-900 transition ${
