...
async function runTests() {
  ...
  try {
    ...
    process.env.VIDEO_MAX_DURATION_MINUTES = '999'; // Exceeds 240 minute limit
    ...
    if (config.videoMaxDurationMinutes !== 240) throw new Error('Assertion failed: video duration limit was not capped at 240 minutes');
